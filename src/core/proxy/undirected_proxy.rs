use crate::core::{
	BaseGraph, Constrainer, Directed, Graph, GraphMut, ImplGraph, ImplGraphMut, NewVertex,
	RemoveVertex, Undirected,
};
...
impl<C: Constrainer> BaseGraph for UndirectedProxy<C> where C::Graph: Graph<Directedness = Directed> {}
